...
gsap.to(imageDivRef.current, {
    scrollTrigger: {
        ...
        scrub: 0.2,
        onUpdate: (e) => {
            const imageIndex=Math.floor(e.progress * (imageArr.length-1));
...
<div >
        ...
        <div ref={imageDivRef} className='absolute h-[20vw] overflow-hidden rounded-4xl w-[15vw] top-50 left-[30vw] '>
    ...
    <div className=' relative font-[font2]'>
      ...
      <div className='pl-[50%]  mt-20 mr-6'>
        <p className='lg:text-5xl text-[50%]'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Notre curiosité nourrit notre créativité. On reste humbles et on dit non aux gros egos, même le vôtre. Une marque est vivante. Elle a des valeurs, une personnalité, une histoire. Si on oublie ça, on peut faire de bons chiffres à court terme, mais on la tue à long terme. C’est pour ça qu’on s’engage à donner de la perspective, pour bâtir des marques influentes.</p>
      </div>
...
<footer className='text-sm text-center mb-5'><pre>
          © 2024 Soixan7e Douze. Tous droits réservé
 
<br /><br /><br />
 conatact <a href=".">+91 1234567890</a>
